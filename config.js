...
const CONFIG = {
  ...
  farewell: {
    ...
    note: 'We’d be so happy to celebrate with the friends and families who have made our time here so special—Hayley would especially love to see her classmates and friends.',
  ...
  birthday: {
    ...
    date: '2025-11-16', time: '11:00 AM - 1:00 PM',
    location: 'Brookhaven Park, 4158 Peachtree Rd NE, Atlanta, GA 30319',
    note: "We'll be having a baby music class! You're encouraged to bring instruments so kids can make some music together.",
    calendarTitle: "Jenna & Charlie's 1st Birthday Party",
    calendarDescription: "Join us for Jenna & Charlie's 1st Birthday celebration!"
  }
};
